...
1. Щоб додати контакт до довідника, введіть <<< add record >>>  ім'я, номер телефону у форматі «+xx-xxx-xxx-xx-xx», «дату народження» у форматі дд-мм-рррр» >>> використовуйте пробіл без коми 
